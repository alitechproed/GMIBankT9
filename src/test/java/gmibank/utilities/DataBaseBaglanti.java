...
public class DataBaseBaglanti {
    ...
    private static  String dbusername = ConfigurationReader.getProperty("username");
    private static  String dbpassword = ConfigurationReader.getProperty("password");
    private static  String connectionUrl = ConfigurationReader.getProperty("db_url");
